...
var PaginationBox = function (_Component) {
  ...
  function PaginationBox() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = PaginationBox.__proto__ || Object.getPrototypeOf(PaginationBox)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      selected: _this.props.page
    }, _this.handlePreviousPage = function () {
      if (_this.state.selected > 1) {
        return _this.state.selected - 1;
      }
      return _this.state.selected;
    }, _this.handleNextPage = function () {
      if (_this.state.selected < _this.props.pageCount) {
        return _this.state.selected + 1;
      }
      return _this.state.selected;
    }, _this.displayFirstButton = function () {
      if (_this.props.pageCount > _this.props.pageRangeDisplayed && _this.state.selected !== 1) {
      ...
      if (_this.props.pageCount > _this.props.pageRangeDisplayed && _this.state.selected !== _this.props.pageCount) {
        return _react2.default.createElement(_PaginationItem2.default, {
      ...
      if (maxPageCount > pageRange) {
        ...
        var relatedLowerBound = _this.state.selected - 1 - lowerBound;
        var relatedHigherBound = _this.state.selected - 1 + higherBound;
      ...
      for (var index = min; index <= max; index += 1) {
        items.push(_react2.default.createElement(_PaginationItem2.default, {
          ...
          selected: _this.state.selected === index + 1,
